...
.custom-select {
  ...
  width: 200px; /* Atur lebar select sesuai kebutuhan */
  text-align-last: center; /* Pusatkan teks di dalam select */
}
...
.table-container {
  ...
  border-radius: 5px;
  overflow: hidden;
  width: 80%; /* Atur lebar table container */
  margin: 0 auto; /* Pusatkan container table */
  margin-top: 20px;
